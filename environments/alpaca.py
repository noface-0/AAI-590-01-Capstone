...
class AlpacaPaperTrading():
    ...
    def __init__(
        ...
        try:
            ...
            raise ValueError(
                'Fail to connect Alpaca. '
                'Please check account info and internet connection.'
            )
    ...
    def run(self):
        ...
        while True:
          ...
          if(self.timeToClose < (60)):
            ...
            # wait for market to close to extract data and retrain
            # time.sleep(60)
            # TODO: put data download and retraining mechanisms
            break
    ...
    def trade(self):
        ...
        if self.drl_lib == 'elegantrl':
            ...
            raise ValueError(
                'The DRL library input is NOT supported yet. '
    ...
    def submitOrder(self, qty, stock, side, resp):
        if(qty > 0):
          try:
            ...
            print(
                "Market order of | " 
                + str(qty) + " " + stock + " " + side + " | completed."
            )
            resp.append(True)
          except:
            print(
                "Order of | " + str(qty) + " " 
                + stock + " " + side + " | did not go through."
            )
            resp.append(False)
        else:
          print(
              "Quantity is 0, order of | " + str(qty) + " " 
